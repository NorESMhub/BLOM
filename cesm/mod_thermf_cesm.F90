...
contains
  ...
  subroutine thermf_cesm(m,n,mm,nn,k1m,k1n)
    ...
    real, dimension(    1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) :: tfrzm
    real, dimension(    1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) :: vrtsfl
    real, dimension(ntr,1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) :: ttrsf
    real, dimension(ntr,1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) :: ttrav
