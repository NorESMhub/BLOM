...
!******************************************************************************
  ...
  use mo_biomod, only: atten_c,atten_uv,atten_w,bkopal,bkphy,bkzoo,    &
                     & bsiflx0100,bsiflx0500,bsiflx1000,bsiflx2000,    &
                     & bsiflx4000,bsiflx_bot,                          &
                     & calflx0100,calflx0500,calflx1000,calflx2000,    &
                     & calflx4000,calflx_bot,                          &
                     & carflx0100,carflx0500,carflx1000,carflx2000,    &
                     & carflx4000,carflx_bot,                          &
                     & dremn2o,dremopal,drempoc,dremsul,dyphy,ecan,    &
                     & epsher,fesoly,gammap,gammaz,grami,grazra,       &
                     & expoor,exposi,expoca, intdnit,                  &
                     & intdms_bac,intdmsprod,intdms_uv,intphosy,       &
                     & perc_diron,phosy3d,                             &
                     & pi_alpha,phytomi,rcalc,rcar,rdn2o1,             &
                     & rdn2o2,rdnit0,rdnit1,rdnit2,relaxfe,remido,     &
                     & riron,rnit,strahl,rnoi,ro2ut,ropal,spemor,      &
                     & wcal,wdust,wopal,wpoc,zinges
  use mo_param1_bgc, only: ialkali,ian2o,iano3,icalc,idet,idms,idoc,   &
                     & ifdust,igasnit,iiron,iopal,ioxygen,iphosph,iphy,&
...
#ifdef AGG
  use mo_biomod, only: alar1,alar2,alar3,alow1,alow2,alow3,asize3d,calmax,     &
                     & cellmass,cellsink,dustd1,dustd2,dustd3,dustsink,&
                     & eps3d, &
                     & fractdim,fse,fsh,nmldmin,plower,pupper,sinkexp, &
                     & stick,tmfac,tsfac,vsmall,zdis,wmass,wnumb
