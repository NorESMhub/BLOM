...
#include <mpif.h>
    ...
    ! Arguments
    integer,          intent(in)  :: kcid
    integer,          intent(in)  :: kshort
    integer,          intent(in)  :: kdims
    integer,          intent(in)  :: kcdims(kdims)
    integer,          intent(out) :: kcvarid
    integer,          intent(in)  :: kunitl
    integer,          intent(in)  :: klong
    integer,          intent(in)  :: klabel
    integer,          intent(in)  :: kunit
    character(len=*), intent(in)  :: yshort
    character(len=*), intent(in)  :: yunit
    character(len=*), intent(in)  :: ylong
